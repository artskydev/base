...
function smart_success_box(message,container)
{
	...
	var str =  '<div class="alert alert-success alert-dismissable smart-success-box"><button type="button" class="close" data-bs-dismiss="alert" aria-hidden="true">&times;</button><p><i class="fa fa-check"></i> '+message+'</p></div>';
...
function smart_error_box(message,container)
{
	...
	var str =  '<div class="alert alert-danger alert-dismissable smart-error-box"><button type="button" class="close" data-bs-dismiss="alert" aria-hidden="true">&times;</button><p><i class="fa fa-warning"></i> '+message+'</p></div>';
	$(str).prependTo(container);
}
...
function smart_message(pesan)
{
  ...
  str = str + '</div><div class="modal-footer">';
  str = str + '<button data-dismiss="modal" data-bs-dismiss="modal" class="btn btn-warning" type="button">Ok</button>';
  str = str + '</div></div></div></div>';
  $(str).appendTo('body');
