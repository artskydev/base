                        ...
                        <div class="de-flex sm-pt10">
                                ...
                                <div class="de-flex-col">
                                    ...
                                    <div id="logo">
                                        <a href="<?=site_url("home")?>">
                                            <img alt="" class="logo" src="<?=$templates?>images/logo.png" />
                                            <img alt="" class="logo-2" src="<?=$templates?>images/logo.png" />
                                        </a>
                                    </div>
                                    <!-- logo close -->
                                </div>
                            ...
                            <div class="de-flex-col header-col-mid">
                                ...
                                <div class="menu_side_area"  >
                                    <a  href="<?=site_url("login")?>"  v-on:click="connectWallet" class="btn-main btn-wallet"><i class="icon_wallet_alt"></i><span>Sign in /Sign up</span></a>
                                    <span id="menu-btn"></span>
                                </div>
                                <?php
								}
