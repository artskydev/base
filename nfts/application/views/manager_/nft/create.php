                            ...
                            <form id="form-create-item" class="form-border createnft" method="post" action="javascript:void(0);">
                                <div class="field-set">
									...
									*/
                                    ...
                                    <h5>Title</h5>
                                    <input type="text" name="name" id="name" v-model="name" class="form-control" placeholder="e.g. 'Velocity NFT" />
                                   ...
                                   <!--
                                    ...
                                    <input type="text" name="amount" id="amount" v-model.number="amount" class="form-control" placeholder="Example 1000" min="10" max="100000"/>
                                    -->

                                    <!--
                                    <h5>Royalties</h5>
                                    <input type="text" name="item_royalties" id="item_royalties" class="form-control" placeholder="suggested: 10%, 20%, 30%. Maximum is 70%" min="10"/>
                                    -->
