                            ...
                            <div class=" ">
                              <div class="form-group">
                                ...
                                <div class="input-group mb-3"> 
									...
									<input type="text" class="form-control" aria-label="Reffreal" id="refinput" readonly="readonly" value="<?=site_url('register/views/'.name_identitiy()."-".user_info('id'))?>"> 
                                     <span class="input-group-text" onclick="javascript:CopyToClipboard('refinput');" style="cursor:pointer;"><i class="bx bx-copy"></i></span>
								</div>
