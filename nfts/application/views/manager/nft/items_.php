                        ...
                        <div class="col-md-6">
                            <div class="item_info">
                                ...
                                <div class="item_info_counts">
                                    ...
                                    <div class="item_info_type"><i class="fa fa-book"></i><?=$data['collection']?></div>
								...
								?>
                                    ...
                                    <div class="btn-message-dialog hide">
                                        <strong style='color:green;'> You Are Owner </strong>
                                     </div>
                                 <?php
									}else
									{
								...
								{
								?>
                                 <a href="<?=site_url('login')?>" class='btn-main btn btn-info'> <span>You need Login to Buy/Bid</a>
                                <?php
								}
								?>
                            </div>
