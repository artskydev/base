                ...
                <div class="container">
					<div class="row">
						<div class="col-md-8 offset-md-2">
							<h3>Register now.</h3>
                            <p>Register To <?=isset($setting['website_title'])?$setting['website_title']:""?> After complete this form.</p>
                              ...
                              <div class="message"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="field-set">
                                            <label>Brand Fax:</label>
                                            <input type='text' name='brand_fax' id='brand_fax' class="form-control  ">
                                        </div>
                                    </div>
