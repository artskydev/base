...
function smart_message(pesan)
{
  ...
  str = str + '<div class="modal-content">';
  str = str + '<div class="modal-body">';
  str = str + '<div class="form-control" align="center"><strong>'+pesan+'</strong></div> ';
  str = str + '</div><div class="modal-footer">';
  str = str + '<button data-dismiss="modal" onclick="javascript:modalmessage();" class="btn btn-outline" type="button">Ok</button>';
  str = str + '</div></div></div></div>';
  $(str).appendTo('body');
