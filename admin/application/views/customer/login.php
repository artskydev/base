    ...
    <body class="login-page">
                    ...
                    <div class="card login-box-container">
                        <div class="card-body">
                           ...
                           <form action="javascript:void(0);" role="form" method="post" class="js-validation-login">
                                ...
                                <a href="<?=site_url("plg/register")?>" class="btn btn-primary m-b-xs pull-right" style="float:right;">Sign Up</a>
                                 
                            </div>
                              </form>
                              <div class="authent-reg">
                                  <a href="<?=site_url("plg/login/forgot")?>">Forgot Password?</a>
                              </div>
                        </div>
                    </div>
                </div>
		...
		$(function()
		{
			$('.js-validation-login').submit(function(){
					var req = post('<?=site_url('plg/login/check')?>',$(".js-validation-login").serialize());
