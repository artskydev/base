                           ...
                           <table class="table table-bordered table-striped js-dataTable-full">
                            <thead>
                                <tr>
                                    ...
                                    <th>Fee (<?=settings('token_transaksi')?>)</th> 
                                    <th>From Customer</th> 
                                    <th>Info</th>  
                                </tr>
                            </thead>
...
<script>
var table_ajax;
var curls = "<?=site_url('nft/order/getlist')?>?baru=1";
		...
		if(ids!="")
		{
			bootbox.confirm({
				...
				callback: function (result) {
					if(result)
					{
						var req = post('<?=site_url('nft/order/delete')?>',{id:ids,'<?=$this->security->get_csrf_token_name()?>':smart_token_hash});
