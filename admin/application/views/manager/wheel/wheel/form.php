	...
	<div class="col-md-12">
   	   ...
   	   <div class="card">
            ...
            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>Respon</label>
                                        <input type="text" class="form-control" name="respon" id="respon" placeholder="respond" value="<?=isset($data['respon'])?$data['respon']:''?>" />
                                    </div>
...
$(document).ready(function(){
	$("#frm-object").validate({
		...
		submitHandler:function(){
			...
			var req = postFile('<?=site_url("wheel/wheel/save")?>',data);
			req.done(function(out){
				if(!out.error)
				{
					smart_success_box(out.message,'#frm-object .block-content');
					document.location.href="<?=site_url('wheel/wheel')?>";
				}
				else
				{
