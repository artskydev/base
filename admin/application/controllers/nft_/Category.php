...
class Category extends Smart_Controller
{
	...
	public function getlist()
	{
		if($this->input->is_ajax_request())
		{
			...
			array('db'=>'m_nft_category.displays','dt'=>2,'alias'=>'displays','formatter'=>function($d,$row){
			...
			array('db'=>'m_nft_category.id','dt'=>3,'alias'=>'id','formatter'=>function($d,$row){
				return ' 
